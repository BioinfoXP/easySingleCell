...
RunInferCNVAnalysis <- function(infercnv_path = './output_data/inferCNV/',
                                ...
                                ref_group_names,
                                cutoff = 0.1,
                                denoise = TRUE, HMM = TRUE,cluster_by_groups = TRUE,
                                name = 'infer_run',
                                num_threads = 12, ...) {
  ...
  # Run InferCNV analysis
  infercnv_obj <- infercnv::run(infercnv_obj, cutoff = cutoff, out_dir = out_path,
...
#' @param ... Same with the infercnv::run.
